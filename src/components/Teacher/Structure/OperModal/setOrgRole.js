...
export default class SetOrgRole extends PureComponent {
    constructor(props) {
        super(props);
        this.state = {
    ...
    //选择角色名称
    selectRole(index, value, option) {
        let saveRoleType = Object.assign({}, this.state.saveRoleType);
        saveRoleType[index] = option.key;
        this.setState({
    ...
    render() {
        ...
        const personProps = {
            placeholder: trans('student.setRoleBySelect', '请搜索选择需要在组织下配置该角色的人员'),
            dropdownStyle: {
                maxHeight: 400,
                overflow: 'auto',
            },
                                            ...
                                            <Form.Item label={trans('student.setRole', '配置角色')}>
                                                {getFieldDecorator(`orgRole${item.order}`, {
                                                    ...
                                                    <Select
                                                        ...
                                                        style={{ width: 250 }}
                                                        onChange={this.selectRole.bind(this, index)}
                                                    >
                                                        {configureRoleList &&
                                                            configureRoleList.length > 0 &&
