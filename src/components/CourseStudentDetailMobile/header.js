    ...
    return <div>
      <div className={styles.header}>
        <div className={styles.headerTab}>
            <span className={`${styles.action} ${styles.account}`} onClick={this.organizationClick}>
                  <span className={styles.name} style={{ color: "#595959" }}>{currentUser.schoolName || null}</span>
                  <span className={styles.outer}></span>     
            </span>
            <div className={styles.tabRight}>
              {
                currentUser.userId ?
                <span className={styles.identityTab}onClick={this.selectClick}>
                  <span>{currentUser.currentChildName}</span>
                  <span className={styles.outer}></span>
                </span> : null
              }
              ...
              {
                locale() === 'en' ?
                <i className={[icon.iconfont, styles.switchLan].join(' ')} onClick={this.languageClick}>&#xe64f;</i>
                :
                <i className={[icon.iconfont, styles.switchLan].join(' ')} onClick={this.languageClick}>&#xe61a;</i>
              }
            </div>
