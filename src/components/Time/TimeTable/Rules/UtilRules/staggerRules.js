...
import { Tabs, Input, TreeSelect, message, Select, Spin } from 'antd';
...
export default class StaggerRules extends PureComponent {
    constructor(props) {
        super(props);
        this.state = {
            activeKey: '',
                                            ...
                                            <div className={styles.ruleContainer}>
                                                {item.id == 3 && (
                                                    <div className={styles.ruleTips}>
                                                        <p>
                                                            “错开上-课程”规则表示所选课程的所有班的课上课时间不重叠。举例：设置美术G2、体育G2错开上课，则表示美术G2（3个班共6节课）体育G2（3个班共12节课）共18节课要错开上课。
                                                        </p>
                                                    </div>
                                                )}
                                                {item.id == 4 && (
