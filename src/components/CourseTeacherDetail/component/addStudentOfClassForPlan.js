...
class AddStudent extends React.Component {
    ...
    componentWillReceiveProps(nextProps) {
        // console.log('nextProps.visibleAddStudent', nextProps.visibleAddStudent);
        // console.log('this.props.visibleAddStudent', this.props.visibleAddStudent);
    ...
    initStudentData = (nextLoad = false) => {
        ...
        let url = this.props.isNew
            ? 'courseBaseDetail/studentListNew'
            : 'courseBaseDetail/studentListOfClass';
        dispatch({
            type: url,
            payload: newPayload,
        }).then(() => {
    ...
    handleOkAddStudent = () => {
        ...
        if (this.props.isNew) {
            newPay = {
                groupId: this.props.toAllClassValue,
                userIdList: studentIdsList,
                semesterId: this.props.semesterValue,
            };
            url = 'courseBaseDetail/addStudentClassNew';
        } else {
            newPay = {
                planId,
            ...
            url = 'courseBaseDetail/addStudentClass';
        }
        dispatch({
            type: url,
            payload: newPay,
    ...
    handleChangeStudent = (item, e) => {
        ...
        console.log(studentIdsList, '111');
