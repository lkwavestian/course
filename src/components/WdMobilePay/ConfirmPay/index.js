...
export default class ConfirmPay extends PureComponent {
    constructor(props) {
        ...
        this.state = {
            ...
            deductionAmount: getUrlSearch('deductionAmount'),
        };
    }
    ...
    componentDidMount() {
        ...
        let payNumber = value && value.totalAmount - value.userWalletAmount;
        if (value && value.totalAmountPaid) {
            payNumber - value.totalAmountPaid;
        }
        ...
        this.setState({
            ...
            priceValue:
                tempUseBalance == 'true'
                    ? value && parseFloat(value.arrearsOfMoney) >= parseFloat(tempDedition)
                        ? payNumber
                        : '0.00'
    ...
    render() {
        ...
        let payNumber = detailContent && detailContent.totalAmount - detailContent.userWalletAmount;
        if (detailContent && detailContent.totalAmountPaid) {
            payNumber - detailContent.totalAmountPaid;
        }
        payNumber = !isNaN(payNumber) && payNumber.toFixed(2);
                ...
                <div className={styles.cardAndTitle} style={{ height: '75vh', overflow: 'scroll' }}>
                    ...
                    <span className={styles.aboutPrice}>
                        ...
                        {/* <span className={styles.total}>
                                 ...
                                 ￥{(detailContent && detailContent.totalAmountPaid) || '0.00'}
                             </span> */}
                            ...
                            {detailContent && (
                                ...
                                >
                                    ￥
                                    {
                                        ...
                                        isUseBalance == 'true'
                                            ? detailContent &&
                                              parseFloat(detailContent.arrearsOfMoney) >=
                ...
                <div className={styles.action}>
                    ...
                    <span className={styles.inputPrice}>
                        ...
                        <Input
                            ...
                            disabled={
                                true
                                // detailContent && detailContent.tuitionType == 1 ? true : false
                            }
