...
function PrintBaseInfor(props) {
    // console.log('chooseCoursePlanId', props.chooseCoursePlanId);

    let chooseCoursePlanId = props.chooseCoursePlanId;
    let userSchoolId = props.userSchoolId;
    if (userSchoolId == 'true') {
        userSchoolId = true;
    } else if (userSchoolId == 'false') {
        userSchoolId = false;
    }
        ...
        <>
            <div className={styles.content} id="content">
                <div className={styles.main} style={userSchoolId ? weideStyle : null}>
                    ...
                    <hr style={{ margin: '7px 45px 0 48px' }}></hr>
                                                ...
                                                style={{
                                                    ...
                                                    lineHeight:
                                                        props?.levelList.indexOf('L4') != -1
                                                            ...
                                                            : '',
                                                    position:
                                                        props?.levelList.indexOf('L4' || 'L3') != -1
                                                            ? 'relative'
                                                            : '',
                                                    top:
                                                        props?.levelList.indexOf('L4') != -1
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <p className={styles.grade} /* style={{ display: 'flex' }} */>
                                                ...
                                                <span style={{ marginLeft: 11, color: 'black' }}>
                                                    {periodStr}
                                                    {item.classTimeModels &&
                                                        item.classTimeModels.length &&
                                    ...
                                    <p>
                                        <img
                                            ...
                                            src={
                                                props &&
                                                props.pictureUrlModelList &&
                                                props.pictureUrlModelList[0] != null
                                    ...
                                    <p>
                                        <img
                                            ...
                                            src={
                                                props &&
                                                props.pictureUrlModelList &&
                                                props.pictureUrlModelList[1] != null
                                                    ? window.location.origin +
                                    ...
                                    <p>
                                        <img
                                            ...
                                            src={
                                                props &&
                                                props.pictureUrlModelList &&
                                                props.pictureUrlModelList[2] != null
                                                    ? window.location.origin +
