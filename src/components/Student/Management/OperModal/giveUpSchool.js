...
@Form.create()
@connect((state) => ({}))
class GiveUpSchool extends PureComponent {
    constructor(props) {
        super(props);
        this.state = {
            isJump: false,
    ...
    handleCancel = () => {
        ...
        typeof hideModal == 'function' && hideModal.call(this, 'giveUpSchool');
        form.resetFields();
        this.setState({
            newFileId: [],
        });
    ...
    render() {
        let { giveUpSchoolVisible } = this.props;
        ...
        return (
            <div>
                <Modal
                    visible={giveUpSchoolVisible}
                    title={trans('student.giveUp', '放弃')}
                    footer={null}
                ...
                <Modal
                    ...
                    title={
                        <span>
                            ...
                            />
                            {trans('student.successfully.giveUp', '设置放弃成功')}
                        </span>
                    }
                    footer={null}
                    width={'360px'}
